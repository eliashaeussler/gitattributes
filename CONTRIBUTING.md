...
```bash
# Clone repository
git clone https://github.com/eliashaeussler/gitattributes.git
cd gitattributes
...
Once the changes are ready, please [submit a pull request](https://github.com/eliashaeussler/gitattributes/compare)
